...
int main(int argc, char** argv) {
	...
	int k = 40;
	vector<uint64_t> shift = {12 * 4 * 8, 4 * 8, 8, 1};
	auto jl_info = jl_projector_init(k, shift);
	...
	#ifdef ARGUMENT_EXPORT
	ZKFpExec::zk_exec->end_argument_exporter(200);
	#endif
